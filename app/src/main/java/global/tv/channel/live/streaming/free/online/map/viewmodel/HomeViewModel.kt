package global.tv.channel.live.streaming.free.online.social.food.shopping.viewmodel

import android.content.Context
import android.util.Log
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import global.tv.channel.live.streaming.free.online.social.food.shopping.watch
...
class HomeViewModel : ViewModel() {
    ...
    private fun fetchAllApps(){
        ...
        val watch: watch? = watch.get()
        val dataService: DataService? = watch!!.getDataService()
