...
class Constants {
    ...
    val FB_NATIVE_GLOABAL_1 = "1094318494325208_1143554912734899"
    val FB_NATIVE_GLOBAL_2 = "1094318494325208_1143555152734875"
    ...
    fun getFbNativeGlobal1(): String {
        return if (BuildConfig.DEBUG)
            FB_ADS_TEST
        else
            FB_NATIVE_GLOABAL_1
    }
    fun getFbNativeGlobal2(): String {
        return if (BuildConfig.DEBUG)
            FB_ADS_TEST
        else
            FB_NATIVE_GLOBAL_2
