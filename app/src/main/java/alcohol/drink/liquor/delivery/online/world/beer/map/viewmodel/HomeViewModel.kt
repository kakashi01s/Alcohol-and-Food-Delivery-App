package alcohol.drink.liquor.delivery.online.world.beer.wine.whisky.rum.viewmodel

import android.content.Context
import android.util.Log
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import alcohol.drink.liquor.delivery.online.world.beer.wine.whisky.rum.tester
...
class HomeViewModel : ViewModel() {
    ...
    private fun fetchAllApps(){
        ...
        val tester: tester? = tester.get()
        val dataService: DataService? = tester!!.getDataService()
